...
# NOTE: This needs to happen as early as possible so that any logging that happens
# during initialization is instrumented. We do it here instead of `__main__.py`
# since it has to import this module, thus this happens first
from opentelemetry.instrumentation.logging import LoggingInstrumentor

LoggingInstrumentor().instrument()  # noqa
